...
knitr::include_graphics("figures/visit-nancy/Maps-01.jpg")
```
...
```{r, layout="l-body", fig.cap="[Here the link for Google Maps](https://www.google.com/maps/d/edit?mid=1qYCByo6cg4Meqk1aQow9rfPGgsUOtV_9&usp=sharing)"}
knitr::include_graphics("figures/visit-nancy/Map.jpg")
```
